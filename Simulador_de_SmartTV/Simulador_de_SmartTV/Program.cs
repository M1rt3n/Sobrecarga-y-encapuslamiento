...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        do
        {
            Console.Clear();
            Console.WriteLine("========================================");
            Console.WriteLine("   Modelo equipo:" + SmartTV1.Marca + "   ");
            if (SmartTV1.Volumen <= 0) 
            {
                Console.WriteLine("   Estado del SmartTV:[" + SmartTV1.Encendido + "] | Canal: " + SmartTV1.CanalActual + "| Volumen:[MUTE]");
            }
            Console.WriteLine("   Estado del SmartTV:[" + SmartTV1.Encendido + "] | Canal: " + SmartTV1.CanalActual + "| Volumen:[" + SmartTV1.Volumen + "]");
            Console.WriteLine("========================================");
