...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        do
        {
            Console.Clear();
            Console.WriteLine("========================================");
            Console.WriteLine("  Actividad actual: "+ state +" | Ahorro de batería: " + Batería1._AhorroEnergía + " | Estado de batería: " + Batería1._PorcentajeCarga + "% | Cargando: " + Batería1._CargadorConectado + "");
            Console.WriteLine("========================================");
            ...
            switch (OP)
            {
                ...
                case 2:
                    ...
                    if (Batería1._PorcentajeCarga < 20) 
                    {
                        Batería1._AhorroEnergía = true;
                    }
